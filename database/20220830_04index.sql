...
d:\java202207\database\20220830_04index.sql
///////////////////////////////////////////////////////////////////////////////
...
drop table emp4;
commit;
select count(*) from emp4; --1000000
select * from emp4;


--1) 인덱스를 사용하지 않은 경우
select * from emp4 where name='kim466'; --실행하고 난 후, 여기에 커서 놓고 F10계획설명
                                        --FULL scan, COST 905

select * from emp4 where no=466;        --FULL scan, COST 903

select * from emp4 where sal>300;       --FULL scan, COST 907
