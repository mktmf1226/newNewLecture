...
i:\java202202\database\20220822_01정렬.sql
/////////////////////////////////////////////////////
...
● [Sort 정렬]
  ...
  - 형식) order by 칼럼명1 asc, 칼럼명2 asc, 칼럼명3 asc, ~~~
...
--1차 정렬 : 국어점수 순으로 내림차순 정렬
--2차 정렬 : 국어점수가 같다면 영어를 기준으로 내림차순 정렬
--2차 정렬 : 국어, 영어점수가 같다면 수학을 기준으로 내림차순 정렬
