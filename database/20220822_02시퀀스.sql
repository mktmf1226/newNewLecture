...
i:\java202202\database\20220822_02시퀀스.sql
/////////////////////////////////////////////////////

● [자동으로 일련번호 부여]
  - Oracle Database : sequence 생성
  - M*SQL Database  : identity 제약조건 --마리아, mySQL 등
...
values(1, '홍길동', 89, 85, 90, 'Seoul', '2022-08-22'); --날짜데이터는 문자형태로 추가한다
...
● [시퀀스 Sequence]
  ...
  - 시퀀스 생성 형식)  create sequence 시퀀스명
                     increment by 증가값 start with 시작값;   --옵션
