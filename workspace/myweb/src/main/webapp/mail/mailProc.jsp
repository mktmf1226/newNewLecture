...
<%
	try{
		...
		content+="<tr>";
		content+="	<td>운동화</td>";
		content+="	<td><span style='color:red; font-wight:bold;'>15,000원</span></td>";
		content+="</tr>";
		content+="</table>";
		
		//이미지 출력하기
		content+="<hr>";
		content+="<img src='http://localhost:9090/myweb/images/architect.jpg'>";
		...
		*/
		...
		//메일 내용
		msg.setContent(content, "text/html; charset=UTF-8");//content, 타입
		
		//메일 보낸날짜
		msg.setSentDate(new Date());//오늘 날짜
