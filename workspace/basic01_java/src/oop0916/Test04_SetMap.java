...
public class Test04_SetMap {
	...
	public static void main(String[] args) {
		...
		Iterator iter=set.iterator(); //Iterator은 커서
		...
		System.out.println(db.get("url"));//http://localhost:1521
		System.out.println(db.get("username"));//itwill
        ...
        while(cursor.hasNext()) {
        	...
        	//4)"=" 위치를 기준으로 문자열 분리하기
        	//-> split(), substring(), StringTokenizer클래스 등
