...
class Apple extends Fruit{ //형식)자식클래스 extends 부모클래스
	
	@Override //<-annotation 명령어 뜻: 재정의(리폼)
	void view() {}
	
	/*
	  @Override
	  void disp() {} error. final메소드는 더이상 override할 수 없다
	*/
...
public class Test03_final {
	...
	public static void main(String[] args) {
		...
		//b=4; error. final변수는 다른값으로 대입 불가능
		...
		*/
		...
		//Calendar.YEAR=2022; error. final변수값은 변경할 수 없다
