...
public class BbsCont {
	...
	public ModelAndView bbsForm() {
		...
		mav.setViewName("bbs/bbsForm"); // /WEB-INF/views/bbs/bbsForm.jsp 뷰페이지로 이동
		return mav;
	...
	*/
	...
	public String bbsForm() {
		return "bbs/bbsForm";			// /WEB-INF/views/bbs/bbsForm.jsp 뷰페이지로 이동
	}//bbsForm() end
	...
	public ModelAndView bbsIns(HttpServletRequest req) {
		...
		ModelAndView mav=new ModelAndView();
		mav.setViewName("bbs/bbsResult"); // /WEB-INF/views/bbs/bbsResult.jsp
