...
function getID(){
    ...
    //<input type="text" name="uid" id="uid" class="line">에 접근해 보자   
    ...
    //3)<form>의 컨트롤 요소 접근시 name 사용
    //document현재문서에 memfrm폼에 uid인풋타입텍스트에 value
...
function validate(){
    ...
    jumin1=jumin1.trim(); //맨앞과 맨뒤 공백 제거
